  ...
  async function handleGoogleAuth() {
    ...
    try {
      ...
      try {
        ...
        console.error('[Google Auth Error] Background trigger failed:', err);
        showToast(`Google Sign-in failed: ${err.message || 'Please check your configuration or try again.'}`, 'error');
        showScreen('login');
      }
    ...
    try {
      ...
      if (Storage) {
        try {
          ...
          console.warn('[Sidebar Logout] Supabase signOut error:', e);
        }
      }
